...
const Header: React.FC<HeaderProps> = ({
  ...
  const navItems: NavItem[] = [
    ...
    { id: 'customs',       label: 'Customs',      shortLabel: 'Customs', icon: ScrollText,      onClick: onCustomsClick,       iconColor: '#ea580c', gradient: 'linear-gradient(145deg, #93c5fd 0%, #2563eb 100%)',   activeGradient: 'linear-gradient(145deg, #fb923c 0%, #c2410c 100%)',   labelColor: '#ea580c', shadowColor: 'rgba(234,88,12,0.38)' },
