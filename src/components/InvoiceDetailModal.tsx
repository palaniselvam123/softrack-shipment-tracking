      ...
      <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-4 py-2 border border-surface-line text-navy-900 rounded-md hover:bg-surface-head transition-colors"
              >
        ...
        <div className="p-6">
            ...
            <div className="bg-surface-tile rounded-md p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-[14px] font-semibold text-navy-900">{invoice.dueDate}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-[14px] font-semibold text-navy-900 mb-4">Invoice Information</h3>
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-brand-600">{invoice.shipmentRef}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <FileText className="w-5 h-5 text-gray-400" />
          ...
          {/* Shipment Details */}
          <div className="mt-8">
            <h3 className="text-[14px] font-semibold text-navy-900 mb-4">Shipment Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-surface-tile rounded-md p-4">
                <div className="flex items-center space-x-3 mb-3">
                  <Ship className="w-4 h-4 text-navy-600" />
          ...
          {/* Description */}
          <div className="mt-8">
            <h3 className="text-[14px] font-semibold text-navy-900 mb-4">Description</h3>
            <div className="bg-surface-tile rounded-md p-4">
          ...
          {/* Payment History */}
          <div className="mt-8">
            <h3 className="text-[14px] font-semibold text-navy-900 mb-4">Payment History</h3>
            <div className="bg-surface-tile rounded-md p-4">
