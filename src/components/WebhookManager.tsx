        ...
        <div className="px-6 py-4 border-b border-surface-line">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-field text-gray-500 mt-0.5">Configure webhooks to receive real-time notifications</p>
            </div>
            <button
          ...
          {webhooks.length === 0 ? (
            ...
            <div className="space-y-4">
              {webhooks.map((webhook, index) => (
                <div key={index} className="border border-surface-line rounded-lg p-4">
                      ...
                      <div className="mb-3">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {webhook.events.slice(0, 5).map(event => (
                            <span key={event} className="px-2 py-1 bg-surface-tile text-brand-700 text-xs rounded">
                              {event}
                            </span>
                          ))}
              ...
              <form onSubmit={handleSubmit} className="p-6">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2 max-h-48 overflow-y-auto border border-surface-line rounded-md p-3">
                ...
                <div className="flex items-center justify-end space-x-3 mt-6 pt-6 border-t border-surface-line">
                  <button
                    type="button"
                    onClick={() => {
                      setShowAddForm(false);
